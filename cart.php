...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/fundo_cart.jpg);">
	</section>
				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						...
						<tr class="table-row">
							<td class="column-1">
								<div class="cart-img-product b-rad-4 o-f-hidden">
									<img src="images/nigiri.jpg" alt="IMG-PRODUCT">
								</div>
							</td>
							<td class="colum n-2">Nigiri salmão (4 p)</td>
						...
						<tr class="table-row">
							<td class="column-1">
								<div class="cart-img-product b-rad-4 o-f-hidden">
									<img src="images/sashimi.jpg" alt="IMG-PRODUCT">
								</div>
							</td>
							<td class="column-2">Sashimi (6 p)</td>
							...
							<td class="column-5">1.99€</td>
						</tr>
                        <tr class="table-row">
							<td class="column-1">
								<div class="cart-img-product b-rad-4 o-f-hidden">
									<img src="images/original_bento.jpg" alt="IMG-PRODUCT">
								</div>
							</td>
							<td class="colum n-2">Original Bento</td>
			...
			<div class="flex-w flex-sb-m p-t-25 p-b-25 bo8 p-l-35 p-r-60 p-lr-15-sm">
				<div class="flex-w flex-m w-full-sm">
					<div class="size11 bo4 m-r-10">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="coupon-code" placeholder="Código do cupão">
					</div>
			...
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
				...
				<div class="flex-w flex-sb bo10 p-t-15 p-b-20">
					...
					<div class="w-size20 w-full-sm">
						<input class=" s-text7 p-l-22 p-r-22" type="text" name="phone-number" placeholder="_______________________________">
					</div>
				</div>
				...
				<div class="size15 trans-0-4">
					<!-- Button -->
					<a href="pagar.php" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
