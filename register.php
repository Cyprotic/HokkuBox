...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="height: 250px;width: auto; background-image: url(images/fundo_contactos.jpg);">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment" action="register_him.php" method="POST">
						<h4 class="m-text26 p-b-36 p-t-15">
							Register
						</h4>

                        <div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="user" placeholder="Username">
						</div>
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="last_name" placeholder="Último nome">
						</div>
                        ...
                        <div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" onchange="checkPasswordMatch();" type="password" id="pass_comfirm" placeholder="Comfirme a password">
						</div>
...
<!--===============================================================================================-->
    ...
    <script type="text/javascript">
            ...
            $("#pass_comfirm").keyup(validate);
        });


        function validate() {
          var password1 = $("#password").val();
          var password2 = $("#pass_comfirm").val();
            ...
            if(password1 == password2) {
                ...
                $("#validate-status").text("As passwords não são iguais!");  
            }
