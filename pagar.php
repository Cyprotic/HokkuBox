...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="height: 250px;width: auto; background-image: url(images/fundo_pagar.jpg);">
			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment">
                        ...
                        <select class="bo4 of-hidden size10 m-b-20" name="cars">
                        ...
                        <div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="phone-number" placeholder="Nome do portador">
						</div>
                        
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="name" placeholder="Número do cartão">
						</div>
                        <a class="size15 m-b-20">Data de expiração: </a>
                        <input id="date" type="month">
                        <br><br>
                        
                        <div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="name" placeholder="CVV">
						</div>
                        
                        <div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="name" placeholder="Morada">
						</div>

						<div class="w-size25">
							<!-- Button -->
                           
							<a href="increment_promo.php" class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4">
								Enviar
							</a>
						</div>
					</form>
